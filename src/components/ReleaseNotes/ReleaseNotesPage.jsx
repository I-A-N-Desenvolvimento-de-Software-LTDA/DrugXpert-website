...
const ReleaseNotesPage = () => {
  return (
    <>
      <SEO 
        title="DrugXpert Release Notes and Roadmap" 
        description="Stay updated with the latest features, improvements, and future plans for the DrugXpert platform." 
        keywords={['release notes', 'updates', 'new features', 'roadmap', 'DrugXpert', 'pharmaceutical software', 'version history']} 
      />
